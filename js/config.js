...
const GAME_EDITION = 'arles-ouverture-2026';
const FIXED_ONLY_EDITION = true;
const loginVersion = document.getElementById('loginVersion');
if (loginVersion) loginVersion.textContent = (FIXED_ONLY_EDITION ? 'ARLES OUVERTURE 2026 · ' : 'JOUEUR · ') + GAME_VERSION + ' · ' + SUPABASE_ENV.label;
document.getElementById('gameVersion').textContent = 'Urban3DQuest.fr · Jadikan ' + (FIXED_ONLY_EDITION ? 'ARLES OUVERTURE 2026 · ' : '') + GAME_VERSION + ' · JOUEUR · ' + SUPABASE_ENV.label;
